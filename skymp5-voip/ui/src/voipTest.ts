...
document.body.style.background = "rgba(7, 12, 21, 0.92)";
      ...
      <div class="voip-column">
        ...
        <section class="voip-card">
          ...
          <dl class="voip-grid">
            ...
            <dt>Positional Audio</dt><dd id="positional-audio">enabled</dd>
...
const render = (state: VoipState) => {
  ...
  elements.positionalAudio.textContent = state.positionalAudioEnabled ? "enabled" : "disabled";
