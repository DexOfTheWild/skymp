  ...
  <div class="raw-shell">
    <div class="raw-card">
      ...
      <dl class="raw-grid">
        ...
        <dt>Positional Audio</dt><dd id="raw-positional">enabled</dd>
...
const render = (state: VoipState) => {
  ...
  elements.radius.textContent = state.proximityRadius === null ? "pending" : String(state.proximityRadius);
  elements.positional.textContent = state.positionalAudioEnabled ? "enabled" : "disabled";
