...
export const SKYMP_CLIENT_ADDON_HOST_VERSION = 6 as const;

export type ClientAddonBrowserMediaPermissionPolicy =
  | "default"
  | "secureOriginAudioCapture";

export type ClientAddonCapabilities = {
  browser: {
    mediaPermissionPolicies: ClientAddonBrowserMediaPermissionPolicy[];
  };
...
export type ClientAddonBrowserApi = {
  ...
  setMediaPermissionPolicy: (policy: ClientAddonBrowserMediaPermissionPolicy) => void;
...
export type ClientAddonConsoleCommandContext = {
  addonId: string;
  commandName: string;
...
export type ClientAddonConsoleCommandHandler = (
  args: string[],
  context: ClientAddonConsoleCommandContext,
) => boolean | void;
