...
import { getModsSnapshot, reorderMods, syncServerLoadOrder, toggleMod } from './mods-service.js';
...
export async function startDashboard({
  ...
  app.post('/api/mods/sync-server-load-order', (req, res) => {
    try {
      const runtime = buildRuntime();
      const runtimeStatus = getRuntimeStatus(runtime);
      const result = syncServerLoadOrder(runtime, {
        runtimeStatus,
      });
      res.json(result);
    } catch (e) {
